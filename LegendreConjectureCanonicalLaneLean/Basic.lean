/-!
# legendre-conjecture-canonical-lane Lean migration boundary
...
`LegendreConjectureCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "legendre-conjecture-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/legendre-conjecture-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for Legendre's Conjecture: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["mathematical-proof", "number-theory", "prime-distribution", "prime-gaps", "reproducibility", "legendre-conjecture", "short-intervals", "canonical-lane", "local-to-global", "manifold-constrained"]
