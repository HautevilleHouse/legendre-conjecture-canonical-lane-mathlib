# Legendre Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/legendre-conjecture-canonical-lane-mathlib.git
cd legendre-conjecture-canonical-lane-mathlib
lake exe
lake build
```
